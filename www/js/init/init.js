...
.run(['$rootScope','$ionicPlatform','$state','$timeout','ServerComS','UserS','$ionicHistory',
     function($rootScope,$ionicPlatform,$state,$timeout,ServerComS,UserS,$ionicHistory){

   $ionicPlatform.ready(function(){
    //navigator.splashscreen.show()
    //$rootScope.serverUrl= 'https://node-dev-env1-muffasa.c9users.io:8080/'
    //$rootScope.serverUrl= 'https://presence-node-clean-muffasa.c9users.io:8080/'
    ...
    $rootScope.settingsUpTime = 15 
     //return $state.go('work-space')
      ...
      $timeout(function() {
          if(!$rootScope.noInit){ //entering the app from notification
